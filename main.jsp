					...
					<td id=nav class=left_col>
						<div ng-repeat="menuItem in menuItems" class=fieldDiv>
							<div id=menuItemDiv{{menuItem.name}}>
								&nbsp
								<span class=bold2 style="font-style:{{menuItem.font_style}};" ng-click="menuItem.isCollapsed=!menuItem.isCollapsed;collapse(menuItem);menuItemClicked(menuItem);">&nbsp{{menuItem.name}}&nbsp</span>
							</div>
